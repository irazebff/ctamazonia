          ...
          `,
            ...
            <Container className="relative z-10 flex min-h-[680px] items-center py-24 lg:py-32">
                <div className="max-w-4xl">
                    <span className="motion-reveal motion-delay-1 text-sm font-semibold uppercase tracking-[0.32em] text-cyan-400">
                        {siteConfig.company.legalName}
                    </span>

                    <h1 className="motion-reveal motion-delay-2 mt-7 max-w-4xl text-5xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl">
                        Engenharia para{' '}
                    ...
                    <p className="motion-reveal motion-delay-3 mt-8 max-w-3xl text-lg leading-8 text-slate-300 sm:text-xl">
                        {siteConfig.company.description}
                    </p>

                    <div className="motion-reveal motion-delay-4 mt-10 flex flex-col gap-4 sm:flex-row">
                        <Button
                            size="lg"
                            className="bg-cyan-400 text-slate-950 shadow-lg shadow-cyan-400/10 transition-all duration-300 hover:-translate-y-0.5 hover:bg-cyan-300 hover:shadow-xl hover:shadow-cyan-400/20 active:translate-y-0"
                        >
                        ...
                        <Button
                            size="lg"
                            variant="outline"
                            className="border-white/20 bg-white/5 text-white transition-all duration-300 hover:-translate-y-0.5 hover:border-cyan-400/40 hover:bg-white/10 hover:text-white active:translate-y-0"
                        >
                            {siteConfig.cta.secondary}
                        </Button>
                    </div>
                    {/* Expertise */}
                    <div className="motion-reveal motion-delay-5 mt-14 border-t border-white/10 pt-8">
